    ...
    <Root title={"HMO Standard"}>
      ...
      <Section sectionName={"plan-prices"}>
        <SplitScreen>
          <div className="plan-prices__img">
            <Image
              src={require("@/assets/img/hmo-standard.png")}
            ...
            >
              <div className="plan-prices__price--1">
                <span className="plan-prices__amt">
                  ₦280,000
                  <span className="pricing__amt-dollar">($560.00)</span>
                </span>
              ...
              <div className="plan-prices__price--2">
                <span className="plan-prices__amt">
                  ₦160,000{" "}
                  <span className="pricing__amt-dollar">($320.00)</span>
                </span>
      ...
      <Section sectionName={"plan-details"}>
        <div className="plan-details__caption">
          <h2 className="heading heading--display">Standard Plan Details</h2>
        </div>
        <table>
          <thead>
            <tr>
