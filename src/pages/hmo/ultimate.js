    ...
    <Root title={"HMO Ultimate"}>
      ...
      <Section sectionName={"plan-prices"}>
        <SplitScreen>
          <div className="plan-prices__img">
            <Image
              src={require("@/assets/img/hmo-ultimate.png")}
            ...
            >
              <div className="plan-prices__price--1">
                <span className="plan-prices__amt">
                  ₦600,000
                  <span className="pricing__amt-dollar">($1200.00)</span>
                </span>
              ...
              <div className="plan-prices__price--2">
                <span className="plan-prices__amt">
                  ₦500,000
                  <span className="pricing__amt-dollar">($1000.00)</span>
                </span>
      ...
      <Section sectionName={"plan-details"}>
        <div className="plan-details__caption">
          <h2 className="heading heading--display">Platinum Plan Details</h2>
        </div>
        <table>
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div className="table__item">
                  <span className="table__item-name">General consultation</span>
              ...
              <td>
                <div className="table__item">
                  <span className="table__item-name">
                    Provision prescribed medication - Basic (15, 000 / Quarter)
                  </span>
            ...
            <tr>
              ...
              <td>
                <div className="table__item">
                  <span className="table__item-name">Physical Examination</span>
